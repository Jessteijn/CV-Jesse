            ...
            <div>
                {
                    side === 'left' ? (
                        <div className={`columns ${styles.timeline}`}>
                            <div className={`${styles.circle} is-hidden-mobile`} style={{backgroundColor: color}}></div>
                            <div className={`column ${styles.left} is-6 has-text-right`}>
                                <div className={`${styles.arrow} ${styles['arrow-right']}`} style={{ borderLeftColor: color}}></div>
                                <div className={`${styles.detail} ${styles['detail-left']}`} style={{ borderRightColor: color}}>
                        ...
                        <div className={`columns ${styles.timeline}`}>
                            ...
                            <div className={`column ${styles.right} is-6 has-text-left`}>
                                <div className={`${styles.arrow} ${styles['arrow-left']}`} style={{ borderRightColor: color}}></div>
                                <div className={`${styles.detail} ${styles['detail-right']}`} style={{ borderLeftColor: color}}>
                                    <p className="is-hidden-tablet">{time}</p>
                                    {children}
                                </div>
                            </div>
